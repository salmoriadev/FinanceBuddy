...
| Input, body, CORS, proxy, Helmet, Swagger, and fail-closed production configuration | [`main.ts`](../../apps/api/src/main.ts), [`environment.validation.ts`](../../apps/api/src/config/environment.validation.ts), [`financial-values.ts`](../../apps/api/src/common/validators/financial-values.ts), [`environment.validation.spec.ts`](../../apps/api/test/environment.validation.spec.ts), [`financial-dto-validation.spec.ts`](../../apps/api/test/financial-dto-validation.spec.ts) |
...
| Sanitized security-event persistence and immutable user-ID allowlisted review API | [`security-event.service.ts`](../../apps/api/src/modules/security/security-event.service.ts), [`security-admin.guard.ts`](../../apps/api/src/modules/security/security-admin.guard.ts), [`security-events.controller.integration.spec.ts`](../../apps/api/test/security-events.controller.integration.spec.ts) |
